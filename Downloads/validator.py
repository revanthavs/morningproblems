...
##########################################################################
	...
	CMPUT 274 Fall 2020
	Weekly Exercise = 1
	Exercise: Password validater and Password generater
##########################################################################
"""
...
def generate(n):
    ...
    if n >= 8:
        ...
        # To conform that generated password whether its secure or not
        if validate(password) == "Secure":
        	# If the genereted password secure returning the generated password
            return(password)
